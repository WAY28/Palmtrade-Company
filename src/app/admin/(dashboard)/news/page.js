...
import { slugify, formatDate, placeholder, nullsToEmpty } from '@/lib/utils'
...
export default function AdminNewsPage() {
  ...
  const openEdit = (post) => { setEditing(post); setForm(nullsToEmpty(post)); setTab('id'); setModal(true) }
